...
const Dropdown = ({ children, text }: { children?: ReactNode, text: string }) => {
    ...
    return <div className='dropdown-container'>
        <p className='dropdown-title' onClick={() => setDropdownOpen((prevState) => !prevState)}>
            <span className='dropdown-caret' style={{ transform: opened ? 'rotate(90deg)' : '' }}>{'⮞'} </span>
