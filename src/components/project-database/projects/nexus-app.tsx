        ...
        <ul className='features-list'>
            <List text={<Bold>Developer Features:</Bold>}>
                ...
                <ul>
                    ...
                    <li><Bold>Templates:</Bold> Quickly start building using numerous templates that fit your needs, whether you want to use React, plain HTML, or more.</li>
                    ...
                    <li><Bold>Limitless Possibilities:</Bold> Built on Electron, Nexus lets you use the full Electron API and any NPM package - no constraints, just creativity.</li>
                </ul>
            </List>
